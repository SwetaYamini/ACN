...
\begin{itemize}
	...
	\end{itemize}
	\item Timestamp: 
		\item Handle domain level inconsistencies in "SDN Datapath" (Domain Network)
		\item Each domain i maintains a vector timestamp T_i[1...n] 
		\item (Routers in) A Domain may change flow depending on their timestamps
	\end{itemize}   
\end{itemize}
}

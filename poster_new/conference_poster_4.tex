...
\documentclass[portrait,a1paper,fontscale=0.45]{baposter} % Adjust the font scale/size here
...
{\hspace{120pt} \includegraphics[height=8em]{UIUC_logo.png}} % Second university/lab logo on the right
...
\headerbox{METRICS}{name=metrics,column=0,span=3,row=2,below=solution}{
\begin{itemize}
...
\headerbox{RESULTS}{name=results,column=0,span=2,row=3,below=metrics}{
...
\headerbox{RESOURCES}{name=resources,column=2,span=1,row=3,below=metrics}{

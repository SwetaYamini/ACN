...
/*
 *  Based on https://github.com/dound/envi/blob/master/gui/src/org/openflow/util/string/IPUtil.java
 */
...
public class IPUtil {
	...
	public static int stringToIP(String ip) {
		...
		if (terms.length != 4)
			throw new NumberFormatException("stringToIP needs correct ip, got "
					+ ip);
	...
	public static void main(String args[]) {
		...
		logger.info(""+ip);
		logger.info(toString(ip));
		logger.info(""+stringToIP(toString(ip)));
	}

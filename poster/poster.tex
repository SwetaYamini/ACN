...
\Huge \color{NavyBlue} \textbf{Hierarchical Controller Architecture} \color{Black}\\ % Title
\Huge\color{NavyBlue}\text{in Software Defined Networks}\\[1cm] % Subtitle
\Large \textbf{Author1 \& Author2}\\[0.5cm] % Author(s)
=======
\begin{minipage}[b]{0.85\linewidth}
\veryHuge \color{NavyBlue} \textbf{Hierarchical Controller Architecture} \color{Black}\\ % Title
\Huge\color{NavyBlue}\text{in Software Defined Networks}\\[1cm] % Subtitle
\huge \text{Gourav Khaneja \& Sweta Seethamraju \& Praveen Kumar}\\[0.5cm] % Author(s)
>>>>>>> 60dbaf88e2ea26d1c9e06f96d58e2910da8bd38a
